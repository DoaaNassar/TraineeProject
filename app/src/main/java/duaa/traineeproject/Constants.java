...
/**
 * Created by AL-Qema on 24/02/18.
 */
...
public class Constants {
    ...
    public static final String GET_FACULTY = baseUrl +"api/get-all-collages/";
    ...
    public static final String GET_PLACE = baseUrl +"api/getAllPlaces";
